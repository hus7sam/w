...
<div class="container  container-fluid ">
    ...
    <!--  *-*-*-*-*-*-*-* بداية البحث   *-*-*-*-*-*-*-*-*-*-   -->
    <div class="row   bg-gradient  my-5  rounded-3 anmaHu shadow-lg" >
        <!--    start column 1  -->
        <div class="col p-4 justify-content-center ">
            <!--    start form 1  -->
            <form action="test.php" method="POST" class="row g-3 justify-content-center">
...
//            <!--   *-*-*-*-*-*-*-* بداية عملية جلب البيانات من قاعدة البيانات  *-*-*-*-*-*-*-*-*-*-   -->
        if ($is_display >= 1){
            ...
            echo "<div class='row g-1 anmaHu  row-cols-1 row-cols-sm-2 row-cols-md-5 justify-content-center'>";
//        <!--   *-*-*-*-*-*-*-*     بداية عرض  البحث   *-*-*-*-*-*-*-*-*-*-   -->
            foreach($rows as $row){
                ?>
                 <div class="col">
                <div class="card p-0 m-1  shadow-lg bg-gradient" ;">
                    ...
                    <div class="card-body p-0 pb-2 text-center">
                        ...
                        <br>
                        <div class="card-link  btn btn-outline-success py-0 my-2 mb-0 "><?php  echo $row['Number']; ?></div>
                        <div href="#" class="card-link  btn btn-outline-danger py-0 my-2  mb-0"><?php echo date("Y-m-d ",strtotime($row['Date'])); ?></div>
                    </div>
